...
public class UtilityTypeAttackerSkillImpl implements AttackerUtilityTypeSkill {
    ...
    @Override
    public void utilityTypeAttackerBrokenShield(Character attacker, Character defender) {
        // 부러진 방패 스킬(확률 발동)
    ...
    @Override
    public void utilityTypeAttackerBrokenSpear(Character attacker, Character defender) {
        // 부러진 창 스킬(확률 발동)
    ...
    @Override
    public void utilityTypeAttackerDoItAgain(Character attacker, Character defender) {
        // 다시하기 스킬 사용(확률 발동)
    ...
    @Override
    public void utilityTypeAttackerOffenseDefenseShift(Character attacker, Character defender) {
        // 공수교대 사용(확률 발동)
    ...
    @Override
    public void utilityTypeAttackerStrongAndWeak(Character attacker, Character defender) {
        // 강약약강 스킬(확률 발동)
    ...
    @Override
    public void utilityTypeAttackerSwap(Character attacker, Character defender) {
        // 바꿔치기 스킬 사용(확률 발동)
