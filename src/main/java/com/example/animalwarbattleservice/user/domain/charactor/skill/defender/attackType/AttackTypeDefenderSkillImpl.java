...
public class AttackTypeDefenderSkillImpl implements DefenderAttackTypeSkill {
    ...
    @Override
    public Integer attackTypeDefenderBerserker(CharacterDto attacker, CharacterDto defender) {
        // 스킬 가능 여부
    ...
    @Override
    public Integer attackTypeDefenderBombDrop(CharacterDto attacker, CharacterDto defender) {
        // 스킬 가능 여부
        if(!defender.isAttackSkill()){
            return 0;
        }
    ...
    @Override
    public Integer attackTypeDefenderExecution(CharacterDto attacker, CharacterDto defender) {
        // 스킬 가능 여부
        if(!defender.isAttackSkill()){
            return 0;
        }
    ...
    @Override
    public Integer attackTypeDefenderHiddenAce(CharacterDto attacker, CharacterDto defender) {
        // 스킬 가능 여부
        if(!defender.isAttackSkill()){
            return 0;
        }
    ...
    @Override
    public Integer attackTypeDefenderPoison(CharacterDto attacker, CharacterDto defender) {
        // 스킬 가능 여부
        if(!defender.isAttackSkill()){
            return 0;
        }
    ...
    @Override
    public Integer attackTypeDefenderSpeedRun(CharacterDto attacker, CharacterDto defender) {
        // 스킬 가능 여부
        if(!defender.isAttackSkill()){
            return 0;
        }
